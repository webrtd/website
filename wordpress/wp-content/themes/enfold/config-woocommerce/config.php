...
function avia_woocommerce_display_output_upsells()
{
	...
	if(!empty($products))
	{
		...
		$output  = "</div></div></div>";
		$output .= '<div class="avia-section alternate_color avia-section-small  container_wrap fullsize"><div class="container"><div class="template-page content  twelve alpha units">';
		$products .= $output;
		echo $products;
	}
}
