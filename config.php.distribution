...
*/
	...
	if (!defined("CONFIG_LOADED"))
	{
		...
		define("DISABLE_MAIL_SENDING", false);		
		...
		define("DATABASE_HOST", "XXXXXXXXXXXX");
		define("DATABASE_USER", "XXXXXXXXXXXXX"); 
		define("DATABASE_PASSWORD", "XXXXXXXXXXXXXXX"); 
		/// import protection
		define("IMPORT_PASSWORD", "XXXXXXXXXXXXXX");
	
		// cron job password
		define("CRONJOB_PWD", "XXXXXXXXXXXXXXX");
